...
var $author$project$OOP$Syntax$VEmpStr = {$: 'VEmpStr'};
...
var $author$project$OOP$Syntax$VString = F2(
	function (a, b) {
		return {$: 'VString', a: a, b: b};
	});
		...
		switch (objects.$) {
			...
			case 'VString':
				...
				return _Utils_Tuple2(
					_Utils_Tuple3(
						false,
						A2($author$project$OOP$Syntax$VString, v1, v2),
						iter),
					state);
			case 'VEmpStr':
				return _Utils_Tuple2(
					_Utils_Tuple3(false, $author$project$OOP$Syntax$VEmpStr, iter),
					state);
			default:
				return _Utils_Tuple2(
					_Utils_Tuple3(
		...
		switch (l1.$) {
			...
			case 'VString':
				...
				return A2(
					...
					v1,
					A2($author$project$OOP$LangUtils$appendValueString, vs1, l2));
			default:
				return $author$project$OOP$Syntax$VError('Operand Error : 11.');
		}
	});
var $author$project$OOP$Syntax$VChar = function (a) {
	return {$: 'VChar', a: a};
};
var $author$project$OOP$Parser$Value$stringToValue = function (s) {
	if (!s.b) {
		return $author$project$OOP$Syntax$VEmpStr;
	} else {
		var c = s.a;
		var cs = s.b;
		return A2(
			...
			$author$project$OOP$Parser$Value$stringToValue(cs));
	}
};
				...
				A2(
					...
					A2(
						...
						A2(
							...
							val,
							$author$project$OOP$Parser$Value$stringToValue(
								$elm$core$String$toList(' Add'))),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$OOP$Parser$Value$stringToValue(
								$elm$core$String$toList('class')),
								$author$project$OOP$Parser$Value$stringToValue(
								$elm$core$String$toList('Object'))
							]))
					])),
...
var $author$project$OOP$Syntax$TString = F3(
	function (a, b, c) {
		return {$: 'TString', a: a, b: b, c: c};
	});
		...
		switch (l1.$) {
			...
			case 'TString':
				...
				return A3(
					...
					ws,
					v1,
					A2($author$project$OOP$LangUtils$appendTermString, vs1, l2));
			default:
				return $author$project$OOP$Syntax$TError('Operand Error : 14.');
		}
	});
...
var $author$project$OOP$Syntax$TEmpStr = function (a) {
	return {$: 'TEmpStr', a: a};
};
var $author$project$OOP$LangUtils$strToTString = function (lc) {
	if (!lc.b) {
		return $author$project$OOP$Syntax$TEmpStr(_List_Nil);
	} else {
		var c = lc.a;
		var cs = lc.b;
		return A3(
			$author$project$OOP$Syntax$TString,
			_List_Nil,
			A2($author$project$OOP$Syntax$TChar, _List_Nil, c),
			$author$project$OOP$LangUtils$strToTString(cs));
	}
};
var $author$project$OOP$Parser$Term$stringToTerm = F2(
	function (ws, lc) {
		if (!lc.b) {
			return $author$project$OOP$Syntax$TEmpStr(ws);
		} else {
			var c = lc.a;
			var cs = lc.b;
			return A3(
				...
				ws,
				A2($author$project$OOP$Syntax$TChar, _List_Nil, c),
				A2($author$project$OOP$Parser$Term$stringToTerm, _List_Nil, cs));
		}
	});
	...
	function (attr, id) {
		if (((((attr.$ === 'TList') && (attr.b.$ === 'TList')) && (attr.b.c.$ === 'TList')) && (attr.b.c.c.$ === 'TEmpList')) && (attr.c.$ === 'TEmpList')) {
			...
			var t2_ = A2(
				...
				t2,
				$author$project$OOP$LangUtils$strToTString(
			...
			return A3(
				...
				A3(
					...
					A3(
						...
						_List_Nil,
						A2(
							$author$project$OOP$Parser$Term$stringToTerm,
							_List_Nil,
							$elm$core$String$toList('class')),
						A3(
							$author$project$OOP$Syntax$TList,
		...
		while (true) {
			switch (hp.$) {
				...
				case 'TString':
					var t1 = hp.b;
					var t2 = hp.c;
					var _v4 = A4($author$project$OOP$Objects$O2HTranslator$twoSubstMerge, env, t1, t2, id);
					var res1 = _v4.a;
					var res2 = _v4.b;
					return A2($author$project$OOP$Syntax$VString, res1, res2);
				case 'TEmpStr':
					return $author$project$OOP$Syntax$VEmpStr;
				case 'TChar':
					var c = hp.b;
				...
				case 'TList':
					var t1 = hp.b;
					var t2 = hp.c;
					var _v8 = A4($author$project$OOP$Objects$O2HTranslator$twoSubstMerge, env, t1, t2, id);
					var res1 = _v8.a;
					var res2 = _v8.b;
					return A2($author$project$OOP$Syntax$VCons, res1, res2);
				case 'TNil':
...
var $author$project$OOP$Parser$Pattern$pnil = A2(
	...
	$author$project$OOP$Parser$WhiteSpaces$mspaces);
var $author$project$OOP$Syntax$PEmpStr = function (a) {
	return {$: 'PEmpStr', a: a};
};
var $author$project$OOP$Syntax$PString = F3(
	function (a, b, c) {
		return {$: 'PString', a: a, b: b, c: c};
	});
var $author$project$OOP$Parser$Pattern$stringToPattern = F2(
	function (ws, s) {
		if (!s.b) {
			return $author$project$OOP$Syntax$PEmpStr(ws);
		} else {
			var c = s.a;
			var cs = s.b;
			return A3(
				...
				ws,
				A2($author$project$OOP$Syntax$PChar, _List_Nil, c),
				A2($author$project$OOP$Parser$Pattern$stringToPattern, _List_Nil, cs));
		}
	});
		...
		A2(
			...
			$elm$parser$Parser$succeed(
				F2(
					function (s, spc) {
						return A2(
							$author$project$OOP$Parser$Pattern$stringToPattern,
							_List_fromArray(
								[spc]),
							$elm$core$String$toList(s));
					})),
...
var $author$project$OOP$Objects$Templates$templates = _List_fromArray(
	[
		_Utils_Tuple3('Input', 'new Input([name, hint])', 'Html.input [] [["name", name]] []'),
		_Utils_Tuple3('TextField', 'new TextField([name, hint, left])', 'Html.p [ ["margin-left", left]\n                    , ["text-align", "left"]\n                    ] \n                    [] \n                    [ hint\n                    ,  Html.input [] [["type", "text"]\n                                    , ["name", name]] []\n                    ]'),
		_Utils_Tuple3('PasswordField', 'new PasswordField([name, hint, left])', 'Html.p [ ["margin-left", left]\n                    , ["text-align", "left"]\n                    ] \n                    [] \n                    [ hint\n                    , Html.input [] [["type", "password"]\n                                    ,["name", name]] []\n                    ]'),
		_Utils_Tuple3('RadioButton', 'new RadioButton([name, hint, value])', 'Html.div [] [] [ Html.input [] [ ["type", "radio"]\n                                            , ["name", name]\n                                            , ["value", value]] []\n                            , hint\n                            ]'),
		_Utils_Tuple3('CheckBox', 'new CheckBox([name, hint, value])', 'Html.div [] [] [ Html.input [] [ ["type", "checkbox"]\n                                            , ["name", name]\n                                            , ["value", value]] []\n                            , hint]'),
		_Utils_Tuple3('SubmitButton', 'new SubmitButton([name, hint, value])', 'Html.input [] [  ["type", "submit"]\n                            , ["name", name]\n                            , ["value", value]] []'),
		_Utils_Tuple3('Form', 'new Form([id, inputs, dataProcess])', 'Html.div [] [] [ Html.form [] [["id", id]] inputs\n                            , Html.script [] [] \n                                        ["  var form = document.getElementById(\'"++id++"\');\n                                            form.addEventListener(\'submit\', (ev)=>{\n                                                ev.preventDefault();\n                                                const data = new FormData(form);" \n                                                ++ dataProcess ++ "});"]\n                            ]'),
		_Utils_Tuple3('NewLine', 'new NewLine([])', 'Html.br [] [] []'),
		_Utils_Tuple3('TextPane', 'new TextPane([id])', 'Html.textarea [] [["id", id]] []'),
		_Utils_Tuple3('WebPage', 'new WebPage([components])', 'Html.div [] [] components'),
		_Utils_Tuple3('Coffee', 'new Coffee([id, price, count])', 'Html.div [["display", "flex"]] []  [ Html.div  [ ["width", "100px"]\n                                                            , ["border-bottom", "1px blue solid"]] [] [id]\n                                                , Html.div  [ ["width", "50px"]\n                                                            , ["border-bottom", "1px blue solid"]] [] [price]\n                                                , Html.div  [ ["width", "50px"]\n                                                            , ["border-bottom", "1px blue solid"]] [] [count]]'),
		_Utils_Tuple3('DisplayArea2', 'new DisplayArea2([menu])', 'Html.div   [["margin-bottom", "50px"]] [] \n                        [ Html.div  [["display", "flex"]] []  \n                                    [ Html.div  [ ["width", "100px"]\n                                                , ["border-bottom", "1px blue solid"]] [] ["Name"]\n                                    , Html.div  [ ["width", "50px"]\n                                                , ["border-bottom", "1px blue solid"]] [] ["Price"]\n                                    , Html.div  [ ["width", "50px"]\n                                                , ["border-bottom", "1px blue solid"]] [] ["Count"]]\n                        , Html.div [] [] menu]'),
		_Utils_Tuple3('ConfirmArea', 'new ConfirmArea([menu, total])', 'Html.div [] [] [ Html.div [["text-align", "left"]] [] ["Please confirm your order:"]\n                            , Html.div  [["display", "flex"]] []  \n                                        [ Html.div  [ ["width", "100px"]\n                                                    , ["border-bottom", "1px blue solid"]] [] ["Name"]\n                                        , Html.div  [ ["width", "50px"]\n                                                    , ["border-bottom", "1px blue solid"]] [] ["Price"]\n                                        , Html.div  [ ["width", "50px"]\n                                                    , ["border-bottom", "1px blue solid"]] [] ["Count"]]\n                            , Html.div [] [] menu\n                            , Html.div [["text-align", "left"]] [] ["total: " ++ total]]'),
		_Utils_Tuple3('Cafe', 'new Cafe([slogan, coffeeArea, confirmArea])', 'Html.div [] [] [ Html.div [] [] [slogan]\n                            , coffeeArea\n                            , confirmArea]')
	]);
	...
	function (ls, id, dict, userDefTemps, state) {
		switch (ls.$) {
			case 'VCons':
				...
				var v2 = ls.b;
				if (v1.$ === 'VNew') {
					var _v35 = A5($author$project$OOP$Objects$O2HTranslator$object2Html, v1, id, dict, userDefTemps, state);
					var v1_ = _v35.a;
					var id1 = _v35.b;
					var dict1 = _v35.c;
					var _v36 = A5($author$project$OOP$Objects$O2HTranslator$expandListAttr, v2, id1, dict1, userDefTemps, state);
					var v2_ = _v36.a;
					var id2 = _v36.b;
					var dict2 = _v36.c;
					...
					var _v37 = A5($author$project$OOP$Objects$O2HTranslator$expandListAttr, v2, id, dict, userDefTemps, state);
					var v2_ = _v37.a;
					var id2 = _v37.b;
					var dict2 = _v37.c;
					return _Utils_Tuple3(
...
var $author$project$OOP$Printer$Value$printString = function (v) {
	_v0$2:
	while (true) {
		switch (v.$) {
			case 'VEmpStr':
			...
			case 'VString':
				if (v.a.$ === 'VChar') {
					...
					return _Utils_ap(
						...
						$author$project$OOP$Printer$Value$printString(v2));
				} else {
					break _v0$2;
				}
			default:
...
var $author$project$OOP$Printer$Value$printValue = function (v) {
	switch (v.$) {
		...
		case 'VString':
			...
			if (v1.$ === 'VChar') {
				var c = v1.a;
				return '\"' + ($elm$core$String$fromChar(c) + ($author$project$OOP$Printer$Value$printString(v2) + '\"'));
			} else {
...
var $author$project$OOP$Objects$Update$iterFieldsRetDefault = function (fields) {
	if (fields.b) {
		...
		var v = function () {
			switch (typ) {
				case 'String':
					return $author$project$OOP$Parser$Value$stringToValue(
						$elm$core$String$toList('Unknown'));
				case 'Int':
	...
	function (v, n) {
		switch (v.$) {
			...
			case 'VString':
				var v1 = v.a;
				var vs = v.b;
				return (!n) ? $author$project$OOP$Syntax$VEmpStr : A2(
					$author$project$OOP$Syntax$VString,
					v1,
					A2($author$project$OOP$LangUtils$vtake, vs, n - 1));
			default:
...
var $author$project$OOP$LangUtils$strToVString = function (lc) {
	if (!lc.b) {
		return $author$project$OOP$Syntax$VEmpStr;
	} else {
		var c = lc.a;
		...
		return A2(
			$author$project$OOP$Syntax$VString,
			$author$project$OOP$Syntax$VChar(c),
			$author$project$OOP$LangUtils$strToVString(cs));
	}
};
			...
			switch (term.$) {
				...
				case 'TFloat':
					...
					return _Utils_Tuple2(
						...
						state);
				case 'TTrue':
					return _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state);
				case 'TFalse':
					return _Utils_Tuple2($author$project$OOP$Syntax$VFalse, state);
				case 'TChar':
					var c = term.b;
					return _Utils_Tuple2(
						$author$project$OOP$Syntax$VChar(c),
				...
				case 'TString':
					var t1 = term.b;
					var t2 = term.c;
					var _v7 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v7.a;
					var state1 = _v7.b;
					var _v8 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v8.a;
					var state2 = _v8.b;
					return _Utils_Tuple2(
						A2($author$project$OOP$Syntax$VString, v1, v2),
						state2);
				case 'TEmpStr':
					return _Utils_Tuple2($author$project$OOP$Syntax$VEmpStr, state);
				case 'TVar':
					var s = term.b;
					var _v9 = A2($author$project$OOP$Utils$findByName, s, env);
					if (_v9.$ === 'Nothing') {
						return _Utils_Tuple2(
				...
				case 'TApp':
					var t1 = term.b;
					var t2 = term.c;
					var _v11 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					if (_v11.a.$ === 'VClosure') {
						var _v12 = _v11.a;
						var p = _v12.a;
						var tf = _v12.b;
						...
						if (t2.$ === 'TFix') {
							...
							var _v15 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
							var v2 = _v15.a;
							var state2 = _v15.b;
				...
				case 'TCase':
					if (term.b.$ === 'TVar') {
						...
						var s = _v18.b;
						var branch = term.c;
						var _v19 = A2($author$project$OOP$Utils$findByName, s, env);
						if (_v19.$ === 'Just') {
							var v = _v19.a;
							var res = A2($author$project$OOP$LangUtils$matchCase, v, branch);
							var _v20 = res.envm;
							if ((_v20.b && (_v20.a.b.$ === 'VError')) && (!_v20.b.b)) {
								var _v21 = _v20.a;
								var info = _v21.b.a;
								return _Utils_Tuple2(
									$author$project$OOP$Syntax$VError(info),
				...
				case 'TCons':
					var t1 = term.b;
					var t2 = term.c;
					var _v22 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v22.a;
					var state1 = _v22.b;
					var _v23 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v23.a;
					var state2 = _v23.b;
					return _Utils_Tuple2(
						A2($author$project$OOP$Syntax$VCons, v1, v2),
				...
				case 'TList':
					var t1 = term.b;
					var t2 = term.c;
					var _v24 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v24.a;
					var state1 = _v24.b;
					var _v25 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v25.a;
					var state2 = _v25.b;
					return _Utils_Tuple2(
						A2($author$project$OOP$Syntax$VCons, v1, v2),
				...
				case 'TTuple2':
					var t1 = term.b;
					var t2 = term.c;
					var _v26 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v26.a;
					var state1 = _v26.b;
					var _v27 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v27.a;
					var state2 = _v27.b;
					return _Utils_Tuple2(
				...
				case 'TTuple3':
					...
					var t2 = term.c;
					var t3 = term.d;
					var _v28 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v28.a;
					var state1 = _v28.b;
					var _v29 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v29.a;
					var state2 = _v29.b;
					var _v30 = A4($author$project$OOP$Eval$eval, env, state2, classtb, t3);
					var v3 = _v30.a;
					var state3 = _v30.b;
					return _Utils_Tuple2(
				...
				case 'TBPrim':
					...
					var t1 = term.c;
					var t2 = term.d;
					var _v31 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v31.a;
					var state1 = _v31.b;
					var _v32 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v32.a;
					var state2 = _v32.b;
					switch (v1.$) {
						case 'VInt':
						...
						case 'VTrue':
							switch (v2.$) {
								case 'VTrue':
									switch (op.$) {
										case 'And':
											return _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state2);
										case 'Or':
											return _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state2);
										default:
											return _Utils_Tuple2(
								...
								case 'VFalse':
									switch (op.$) {
										case 'And':
											return _Utils_Tuple2($author$project$OOP$Syntax$VFalse, state2);
										case 'Or':
											return _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state2);
										default:
											return _Utils_Tuple2(
						...
						case 'VCons':
							switch (v2.$) {
								case 'VCons':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2(
										A2($author$project$OOP$LangUtils$appendValueList, v1, v2),
										state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2(
								...
								case 'VNil':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2(
										A2($author$project$OOP$LangUtils$appendValueList, v1, v2),
										state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2($author$project$OOP$Syntax$VFalse, state2) : _Utils_Tuple2(
							...
							switch (v2.$) {
								case 'VCons':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2(
										...
										_List_Nil));
								case 'VNil':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2($author$project$OOP$Syntax$VNil, state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state2) : _Utils_Tuple2(
						...
						case 'VString':
							switch (v2.$) {
								case 'VString':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2(
										A2($author$project$OOP$LangUtils$appendValueString, v1, v2),
										state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2(
										_Utils_eq(v1, v2) ? $author$project$OOP$Syntax$VTrue : $author$project$OOP$Syntax$VFalse,
										state2) : _Utils_Tuple2(
								...
								case 'VEmpStr':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2(
										A2($author$project$OOP$LangUtils$appendValueString, v1, v2),
										state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2($author$project$OOP$Syntax$VFalse, state2) : _Utils_Tuple2(
										$author$project$OOP$Syntax$VError('Operator Error : 13.'),
										_List_Nil));
								default:
									return _Utils_Tuple2(
							...
							switch (v2.$) {
								case 'VString':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2(
										A2($author$project$OOP$LangUtils$appendValueString, v1, v2),
										state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2($author$project$OOP$Syntax$VFalse, state2) : _Utils_Tuple2(
										$author$project$OOP$Syntax$VError('Operator Error : 14.'),
										_List_Nil));
								case 'VEmpStr':
									return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? _Utils_Tuple2($author$project$OOP$Syntax$VEmpStr, state2) : (_Utils_eq(op, $author$project$OOP$Syntax$Eq) ? _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state2) : _Utils_Tuple2(
										$author$project$OOP$Syntax$VError('Operator Error : 15.'),
										_List_Nil));
								default:
									return _Utils_Tuple2(
										$author$project$OOP$Syntax$VError('Operand Error : 13.'),
										_List_Nil);
							}
						default:
							return _Utils_Tuple2(
				...
				case 'TUPrim':
					...
					var t = term.c;
					if (op.$ === 'Neg') {
						var _v47 = A4($author$project$OOP$Eval$eval, env, state, classtb, t);
						var v = _v47.a;
						var state1 = _v47.b;
						switch (v.$) {
							case 'VInt':
						...
						var _v49 = A4($author$project$OOP$Eval$eval, env, state, classtb, t);
						var v = _v49.a;
						var state1 = _v49.b;
						switch (v.$) {
							case 'VTrue':
								return _Utils_Tuple2($author$project$OOP$Syntax$VFalse, state1);
							case 'VFalse':
								return _Utils_Tuple2($author$project$OOP$Syntax$VTrue, state1);
							default:
								return _Utils_Tuple2(
				...
				case 'TDeRef':
					var t = term.b;
					var _v52 = A4($author$project$OOP$Eval$eval, env, state, classtb, t);
					var v = _v52.a;
					var state1 = _v52.b;
					if (v.$ === 'VLoc') {
						var n = v.a;
						var _v54 = A2($author$project$Utils$nth, n, state);
						if (_v54.$ === 'Just') {
							var val = _v54.a;
							return _Utils_Tuple2(val, state1);
						} else {
							return _Utils_Tuple2(
				...
				case 'TAssign':
					var t1 = term.b;
					var t2 = term.c;
					var _v55 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v55.a;
					var state1 = _v55.b;
					var _v56 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v56.a;
					var state2 = _v56.b;
					if (v1.$ === 'VLoc') {
						var n = v1.a;
				...
				case 'TUnit':
					return _Utils_Tuple2($author$project$OOP$Syntax$VUnit, state);
				case 'TField':
					var t1 = term.b;
					var t2 = term.c;
					if (t2.$ === 'TVar') {
						var f = t2.b;
						var _v59 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
						var v1 = _v59.a;
						var state1 = _v59.b;
						if (v1.$ === 'VNew') {
							var _class = v1.a;
				...
				case 'TInvk':
					...
					if (t2.$ === 'TVar') {
						var m = t2.b;
						var _v63 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
						var v1 = _v63.a;
						var state1 = _v63.b;
						if (v1.$ === 'VNew') {
							var _class = v1.a;
				...
				case 'TNew':
					var _class = term.b;
					var ts = term.c;
					var _v69 = A4($author$project$OOP$Eval$eval, env, state, classtb, ts);
					var vs = _v69.a;
					var state1 = _v69.b;
					return _Utils_Tuple2(
				...
				case 'TSeq':
					var t1 = term.b;
					var t2 = term.c;
					var _v70 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var state1 = _v70.b;
					var _v71 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v71.a;
					var state2 = _v71.b;
					return _Utils_Tuple2(v2, state2);
				case 'THtml':
					var s = term.b;
					var t1 = term.c;
					var t2 = term.d;
					var t3 = term.e;
					var _v72 = A4($author$project$OOP$Eval$eval, env, state, classtb, t1);
					var v1 = _v72.a;
					var state1 = _v72.b;
					var _v73 = A4($author$project$OOP$Eval$eval, env, state1, classtb, t2);
					var v2 = _v73.a;
					var state2 = _v73.b;
					var _v74 = A4($author$project$OOP$Eval$eval, env, state2, classtb, t3);
					var v3 = _v74.a;
					var state3 = _v74.b;
					return _Utils_Tuple2(
				...
				case 'TToStr':
					var t = term.b;
					var _v75 = A4($author$project$OOP$Eval$eval, env, state, classtb, t);
					var v = _v75.a;
					var state1 = _v75.b;
					return _Utils_Tuple2(
						$author$project$OOP$LangUtils$strToVString(
							$elm$core$String$toList(
				...
				case 'TMap':
					var f = term.c;
					var ls = term.d;
					var _v76 = A4($author$project$OOP$Eval$eval, env, state, classtb, f);
					var v1 = _v76.a;
					var state1 = _v76.b;
					var _v77 = A4($author$project$OOP$Eval$eval, env, state1, classtb, ls);
					var v2 = _v77.a;
					var state2 = _v77.b;
					return A4($author$project$OOP$Eval$vmap, v1, v2, state2, classtb);
				default:
					var n = term.b;
					return _Utils_Tuple2(
						$author$project$OOP$Syntax$VLoc(n),
...
var $author$project$OOP$Objects$H2OTranslator$equalVStrAndTStr = F2(
	function (vstr, tstr) {
		equalVStrAndTStr:
		while (true) {
			var _v0 = _Utils_Tuple2(vstr, tstr);
			_v0$2:
			while (true) {
				switch (_v0.a.$) {
					case 'VString':
						if (((_v0.a.a.$ === 'VChar') && (_v0.b.$ === 'TString')) && (_v0.b.b.$ === 'TChar')) {
							var _v1 = _v0.a;
							var v1 = _v1.a.a;
							var vs2 = _v1.b;
							var _v2 = _v0.b;
			...
			case 'VCons':
				...
				if (((v1.$ === 'VCons') && (v1.b.$ === 'VCons')) && (v1.b.b.$ === 'VNil')) {
					...
					if (_Utils_eq(
						...
						A2(
							$author$project$OOP$Syntax$VString,
							$author$project$OOP$Syntax$VChar(
								_Utils_chr('i')),
							A2(
								$author$project$OOP$Syntax$VString,
								$author$project$OOP$Syntax$VChar(
									_Utils_chr('d')),
								$author$project$OOP$Syntax$VEmpStr)))) {
						return $elm$core$Maybe$Just(
...
var $author$project$OOP$LangUtils$mergeEnv = F3(
	function (env1, env2, ori_env) {
		...
		if ((_v0.a.b && _v0.b.b) && _v0.c.b) {
			...
			if ((((_v7.a.$ === 'VClosure') && (_v7.b.$ === 'VFix')) && (_v7.b.a.$ === 'TLam')) && (_v7.b.a.c.$ === 'TLam')) {
				var _v8 = _v7.a;
				var t1 = _v8.b;
				var _v9 = _v7.b.a;
				var _v10 = _v9.c;
				var t2 = _v10.c;
				return (!_Utils_eq(t1, t2)) ? A2(
					$elm$core$List$cons,
					_Utils_Tuple2(s1, v1),
					A3($author$project$OOP$LangUtils$mergeEnv, env1_, env2_, ori_env_)) : A2(
					$elm$core$List$cons,
					_Utils_Tuple2(s2, v2),
					A3($author$project$OOP$LangUtils$mergeEnv, env1_, env2_, ori_env_));
			} else {
...
var $author$project$OOP$LangUtils$mergeState = F3(
			...
			while (true) {
				if (_v0.a.b) {
					if (_v0.b.b && _v0.c.b) {
						...
						var v = _v3.a;
						var st = _v3.b;
						return (!_Utils_eq(v1, v)) ? A2(
							$elm$core$Result$map,
							function (res) {
								return A2($elm$core$List$cons, v1, res);
							},
							A3($author$project$OOP$LangUtils$mergeState, st1, st2, st)) : A2(
							$elm$core$Result$map,
							function (res) {
								return A2($elm$core$List$cons, v2, res);
							},
							A3($author$project$OOP$LangUtils$mergeState, st1, st2, st));
					} else {
						break _v0$2;
					}
				} else {
	...
	function (ls, dict, userDefTemps, state) {
		switch (ls.$) {
			case 'VCons':
				...
				switch (res.a.$) {
					case 'VError':
						var _v42 = A4($author$project$OOP$Objects$H2OTranslator$foldObjectList, v2, dict, userDefTemps, state);
						var v2_ = _v42.a;
						var state2 = _v42.b;
						return _Utils_Tuple2(
							A2($author$project$OOP$Syntax$VCons, v1, v2_),
					...
					case 'VNew':
						...
						var args = _v43.b;
						var state_ = res.b;
						var _v44 = A4($author$project$OOP$Objects$H2OTranslator$foldObjectList, v2, dict, userDefTemps, state_);
						var v2_ = _v44.a;
						var state2 = _v44.b;
						return _Utils_Tuple2(
							A2(
			...
			if (res.$ === 'Just') {
				...
				if (_class === 'Error') {
					...
					var res1 = A2(
						...
						$author$project$OOP$Objects$Templates$parseTemplates(
							_Utils_ap($author$project$OOP$Objects$Templates$templates, userDefTemps)));
					var _v34 = _Utils_Tuple2(res1, res4);
					if ((_v34.a.$ === 'Just') && (_v34.b.$ === 'Just')) {
						var _v35 = _v34.a.a;
						var objectPattern = _v35.a;
						var htmlPattern = _v35.b;
						var oenv = _v34.b.a;
				...
				switch (_v5.b.$) {
												...
												return A2(
													...
													function (state__) {
														return $elm$core$Result$Ok(
															_Utils_Tuple2(
																A3(
																	$author$project$OOP$LangUtils$mergeEnv,
																	env3,
																	A3($author$project$OOP$LangUtils$mergeEnv, env2, env1, oenv),
																	oenv),
																state__));
													},
													A3($author$project$OOP$LangUtils$mergeState, state3, state_, state));
											},
											A3($author$project$OOP$LangUtils$mergeState, state2, state1, state));
									} else {
					...
					case 'TString':
						if (_v5.a.$ === 'VString') {
							var _v26 = _v5.a;
							var _v27 = _v5.b;
							return A2($author$project$OOP$Objects$H2OTranslator$equalVStrAndTStr, html, hp) ? $elm$core$Result$Ok(
		...
		if ((_v2.a.$ === 'Ok') && (_v2.b.$ === 'Ok')) {
			...
			return A2(
				...
				function (mergedState) {
					return $elm$core$Result$Ok(
						_Utils_Tuple2(
							A3($author$project$OOP$LangUtils$mergeEnv, env1, env2, oenv),
							mergedState));
				},
				A3($author$project$OOP$LangUtils$mergeState, state1, state2, state));
		} else {
...
var $author$project$OOP$Parser$Html$nodeToValue = function (node) {
	switch (node.$) {
		...
		case 'Text':
			var s = node.a;
			return $author$project$OOP$LangUtils$strToVString(
				$elm$core$String$toList(s));
		default:
...
var $author$project$OOP$Printer$String$printPatternString = function (p) {
	_v0$2:
	while (true) {
		switch (p.$) {
			case 'PEmpStr':
			...
			case 'PString':
				if (p.b.$ === 'PChar') {
					...
					return _Utils_ap(
						$elm$core$String$fromChar(c),
						$author$project$OOP$Printer$String$printPatternString(p2));
				} else {
					break _v0$2;
				}
			default:
	...
	return 'print Pattern String Error : 01.';
};
var $author$project$OOP$Printer$Pattern$printPattern = function (p) {
	...
	while (true) {
		switch (p.$) {
			...
			case 'PString':
				if ((p.a.b && (!p.a.b.b)) && (p.b.$ === 'PChar')) {
					var _v13 = p.a;
					var spc = _v13.a;
					var _v14 = p.b;
					var c = _v14.b;
					var p2 = p.c;
					return '\"' + ($elm$core$String$fromChar(c) + ($author$project$OOP$Printer$String$printPatternString(p2) + ('\"' + spc)));
				} else {
					break _v0$16;
				}
			case 'PEmpStr':
...
var $author$project$OOP$Printer$String$printString = function (t) {
	_v0$2:
	while (true) {
		switch (t.$) {
			case 'TEmpStr':
			...
			case 'TString':
				if (t.b.$ === 'TChar') {
					...
					return _Utils_ap(
						$elm$core$String$fromChar(c),
						$author$project$OOP$Printer$String$printString(t2));
				} else {
					break _v0$2;
				}
			default:
...
var $author$project$OOP$Printer$Term$printTerm = function (term) {
	...
	while (true) {
		switch (term.$) {
			...
			case 'TString':
				if ((term.a.b && (!term.a.b.b)) && (term.b.$ === 'TChar')) {
					var _v6 = term.a;
					var spc = _v6.a;
					var _v7 = term.b;
					var c = _v7.b;
					var t2 = term.c;
					return '\"' + ($elm$core$String$fromChar(c) + ($author$project$OOP$Printer$String$printString(t2) + ('\"' + spc)));
				} else {
					break _v0$33;
				}
			case 'TEmpStr':
				...
				while (true) {
					if (ws.b && ws.b.b) {
						if (ws.b.b.b) {
							...
							var _v30 = ws.b;
							var spc2 = _v30.a;
							var _v31 = A2($author$project$OOP$LangUtils$splitFuncDef, _List_Nil, t1);
...
var $author$project$OOP$Printer$ClassTable$printMethods = function (methods) {
	if (methods.b) {
		if ((((methods.a.a.b && methods.a.a.b.b) && methods.a.a.b.b.b) && methods.a.a.b.b.b.b) && (!methods.a.a.b.b.b.b.b)) {
			var _v1 = methods.a;
			var _v2 = _v1.a;
			var spc1 = _v2.a;
			var _v3 = _v2.b;
...
var $author$project$OOP$Printer$ClassTable$printClassDef = function (classDef) {
	if ((((((classDef.a.b && classDef.a.b.b) && classDef.a.b.b.b) && classDef.a.b.b.b.b) && classDef.a.b.b.b.b.b) && classDef.a.b.b.b.b.b.b) && (!classDef.a.b.b.b.b.b.b.b)) {
		var _v1 = classDef.a;
		var spc1 = _v1.a;
		var _v2 = _v1.b;
		var spc2 = _v2.a;
...
var $author$project$OOP$Preclude$Gui$guiLen = function () {
	var _v0 = $author$project$OOP$Preclude$Gui$parsedGui;
	var ls = _v0.b;
	return $elm$core$List$length(ls);
}();
var $author$project$OOP$Preclude$Gui$split = function (_v0) {
	var ws = _v0.a;
	var clt = _v0.b;
	return _Utils_Tuple2(
		ws,
		A2($elm$core$List$drop, $author$project$OOP$Preclude$Gui$guiLen, clt));
};
var $author$project$OOP$Syntax$Delete = {$: 'Delete'};
var $author$project$OOP$Syntax$Keep = {$: 'Keep'};
				...
				switch (v2.$) {
					...
					case 'VCons':
						...
						if (_Utils_eq(v11, v21)) {
							...
							return _Utils_Tuple2(
								n,
								A2($elm$core$List$cons, $author$project$OOP$Syntax$Keep, opList));
						} else {
							return A4(
			...
			case 'VString':
				...
				switch (v2.$) {
					...
					case 'VString':
						...
						var v22 = v2.b;
						if (_Utils_eq(v11, v21)) {
							var _v4 = A2($author$project$OOP$LangUtils$diff, v12, v22);
							var n = _v4.a;
							var opList = _v4.b;
							return _Utils_Tuple2(
								n,
...
var $author$project$OOP$LangUtils$mergeMethods = F4(
	function (methods1, methods2, methods3, methodso) {
		var _v0 = methodso;
		var ws_ms = _v0.a;
		var lso = _v0.b;
		var _v1 = methods3;
		...
		var _v4 = _Utils_Tuple3(
			ls1,
			ls2,
			_Utils_Tuple2(ls3, lso));
		if (((_v4.a.b && _v4.b.b) && _v4.c.a.b) && _v4.c.b.b) {
			var _v5 = _v4.a;
			var _v6 = _v5.a;
			var _v7 = _v6.b;
			var s = _v7.a;
			...
			var lso_ = _v15.b;
			var res = A4(
				$author$project$OOP$LangUtils$mergeMethods,
				_Utils_Tuple2(_List_Nil, ls1_),
				_Utils_Tuple2(_List_Nil, ls2_),
				_Utils_Tuple2(_List_Nil, ls3_),
				_Utils_Tuple2(_List_Nil, lso_)).b;
			return (!_Utils_eq(t1, to)) ? _Utils_Tuple2(
				ws_ms,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						ws_m,
						_Utils_Tuple3(s, p, t1)),
					res)) : ((!_Utils_eq(t2, to)) ? _Utils_Tuple2(
				ws_ms,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						ws_m,
						_Utils_Tuple3(s, p, t2)),
					res)) : _Utils_Tuple2(
				ws_ms,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						ws_m,
						_Utils_Tuple3(s, p, t3)),
					res)));
		} else {
			return _Utils_Tuple2(_List_Nil, _List_Nil);
		}
	});
var $author$project$OOP$LangUtils$mergeClassTable = F4(
	function (classtb1, classtb2, classtb3, classtbo) {
		var _v0 = classtbo;
		var ws_tb = _v0.a;
		var cto = _v0.b;
		var _v1 = classtb3;
		...
		if (((_v4.a.b && _v4.b.b) && _v4.c.a.b) && _v4.c.b.b) {
			...
			var cto_ = _v16.b;
			var res = A4(
				$author$project$OOP$LangUtils$mergeClassTable,
				_Utils_Tuple2(_List_Nil, ct1_),
				_Utils_Tuple2(_List_Nil, ct2_),
				_Utils_Tuple2(_List_Nil, ct3_),
				_Utils_Tuple2(_List_Nil, cto_)).b;
			return _Utils_Tuple2(
				ws_tb,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						...
						_Utils_Tuple3(
							_Utils_Tuple2(c, f),
							fields,
							A4($author$project$OOP$LangUtils$mergeMethods, ls1, ls2, ls3, lso))),
					res));
		} else {
			return _Utils_Tuple2(_List_Nil, _List_Nil);
		}
...
var $author$project$OOP$LangUtils$replaceMethods = F3(
	function (m, t_, methods) {
		var _v0 = methods;
		var ws_ms = _v0.a;
		var ms = _v0.b;
		if (ms.b) {
			...
			var t = _v3.c;
			var ms_ = ms.b;
			return _Utils_eq(m, m_) ? _Utils_Tuple2(
				ws_ms,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						ws_m,
						_Utils_Tuple3(m_, p, t_)),
					ms_)) : _Utils_Tuple2(
				ws_ms,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						ws_m,
						_Utils_Tuple3(m_, p, t)),
					A3(
						$author$project$OOP$LangUtils$replaceMethods,
						m,
						t_,
						_Utils_Tuple2(_List_Nil, ms_)).b));
		} else {
			return _Utils_Tuple2(_List_Nil, _List_Nil);
		}
	});
var $author$project$OOP$LangUtils$replaceClassMethods = F4(
	function (_class, m, t_, classtable) {
		var _v0 = classtable;
		var ws_tb = _v0.a;
		var classtb = _v0.b;
		if (classtb.b) {
			...
			var ms = _v3.c;
			var cds = classtb.b;
			return _Utils_eq(c, _class) ? _Utils_Tuple2(
				ws_tb,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						...
						_Utils_Tuple3(
							_Utils_Tuple2(c, f),
							fs,
							A3($author$project$OOP$LangUtils$replaceMethods, m, t_, ms))),
					cds)) : _Utils_Tuple2(
				ws_tb,
				A2(
					$elm$core$List$cons,
					_Utils_Tuple2(
						...
						_Utils_Tuple3(
							...
							ms)),
					A4(
						$author$project$OOP$LangUtils$replaceClassMethods,
						_class,
						m,
						t_,
						_Utils_Tuple2(_List_Nil, cds)).b));
		} else {
			return _Utils_Tuple2(_List_Nil, _List_Nil);
		}
	});
var $author$project$OOP$LangUtils$updateClassTable = F4(
	function (m, _class, t_, classtb) {
		var res = A3($author$project$OOP$LangUtils$findMethod, m, _class, classtb);
		if (res.$ === 'Just') {
			var _v1 = res.a;
			var owner = _v1.a;
			return A4($author$project$OOP$LangUtils$replaceClassMethods, owner, m, t_, classtb);
		} else {
			return classtb;
		}
	});
		...
		switch (v.$) {
			...
			case 'VString':
				...
				var t1 = A2(
					...
					_List_fromArray(
						['']));
				return A3($author$project$OOP$Syntax$TString, ws, t1, t2);
			case 'VEmpStr':
				return $author$project$OOP$Syntax$TEmpStr(ws);
			case 'VCons':
				var v1 = v.a;
	...
	function (nl, n1) {
		...
		switch (_v0.a.$) {
			...
			case 'VString':
				if (!_v0.b) {
					var _v5 = _v0.a;
					return _Utils_Tuple2($author$project$OOP$Syntax$VEmpStr, nl);
				} else {
					var _v6 = _v0.a;
					var v1 = _v6.a;
					var vs = _v6.b;
					var _v7 = A2($author$project$OOP$LangUtils$vsplit, vs, n1 - 1);
					var l1 = _v7.a;
					var l2 = _v7.b;
					return _Utils_Tuple2(
						A2($author$project$OOP$Syntax$VString, v1, l1),
						l2);
				}
			case 'VEmpStr':
				var _v8 = _v0.a;
				return _Utils_Tuple2($author$project$OOP$Syntax$VEmpStr, $author$project$OOP$Syntax$VEmpStr);
			default:
				return _Utils_Tuple2(
...
var $author$project$OOP$UnEval$arith = F6(
	function (ctx, t1, t2, updates, ws, op) {
		var _v229 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
		var v1 = _v229.a;
		var state1 = _v229.b;
		var _v230 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, t2);
		var v2 = _v230.a;
		var _v231 = updates.value;
		switch (_v231.$) {
			case 'VInt':
				var n = _v231.a;
				var _v232 = function () {
					var _v233 = _Utils_Tuple2(v1, v2);
					_v233$1:
					while (true) {
						_v233$3:
						while (true) {
				...
				var newV_1 = _v232.a;
				var newV_2 = _v232.b;
				var _v237 = _Utils_Tuple2(newV_1, newV_2);
				if ((_v237.a.$ === 'VError') && (_v237.b.$ === 'VError')) {
					return _Utils_Tuple2(
						ctx,
					...
					return A8($author$project$OOP$UnEval$operationUpdate, ctx, op, t1, t2, updates, newV_1, newV_2, ws);
				}
			case 'VFloat':
				var n = _v231.a;
				var _v238 = function () {
					var _v239 = _Utils_Tuple2(v1, v2);
					_v239$1:
					while (true) {
						_v239$3:
						while (true) {
				...
				var newV_1 = _v238.a;
				var newV_2 = _v238.b;
				var _v243 = _Utils_Tuple2(newV_1, newV_2);
				if ((_v243.a.$ === 'VError') && (_v243.b.$ === 'VError')) {
					return _Utils_Tuple2(
						ctx,
						$author$project$OOP$Syntax$TError(
							'Wrong Arith Expression : ' + $author$project$OOP$Printer$Term$printTerm(
			...
			case 'VNil':
				return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? A8($author$project$OOP$UnEval$operationUpdate, ctx, op, t1, t2, updates, $author$project$OOP$Syntax$VNil, $author$project$OOP$Syntax$VNil, ws) : _Utils_Tuple2(
					ctx,
			...
			case 'VEmpStr':
				return _Utils_eq(op, $author$project$OOP$Syntax$Cat) ? A8($author$project$OOP$UnEval$operationUpdate, ctx, op, t1, t2, updates, $author$project$OOP$Syntax$VNil, $author$project$OOP$Syntax$VNil, ws) : _Utils_Tuple2(
					ctx,
					$author$project$OOP$Syntax$TError('Operator Error : 17.'));
			default:
				return _Utils_Tuple2(
					ctx,
					$author$project$OOP$Syntax$TError(
...
var $author$project$OOP$UnEval$comp = F6(
	function (ctx, t1, t2, updates, ws, op) {
		var _v220 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
		var v1 = _v220.a;
		var _v221 = updates.value;
		switch (_v221.$) {
			case 'VTrue':
				if (op.$ === 'Eq') {
					return A8($author$project$OOP$UnEval$operationUpdate, ctx, op, t1, t2, updates, v1, v1, ws);
				} else {
					var _v223 = A4(
						$author$project$OOP$Eval$eval,
						ctx.env,
...
var $author$project$OOP$UnEval$deltaUpdate = F4(
	function (term, delta, ctx, newState) {
		switch (term.$) {
			case 'TList':
				var ws = term.a;
				var t1 = term.b;
				...
				if (delta.b) {
					switch (delta.a.$) {
						case 'Keep':
							...
							var _v190 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
							var v1 = _v190.a;
							var state1 = _v190.b;
							var _v191 = A4(
							...
							var ctx_ = _v192.a;
							var t1_ = _v192.b;
							var newClassTb = A4($author$project$OOP$LangUtils$mergeClassTable, ctx_.classtb, ctx1_.classtb, ctx.classtb, ctx.classtb);
							var newEnv = A3($author$project$OOP$LangUtils$mergeEnv, ctx_.env, ctx1_.env, ctx.env);
							return _Utils_Tuple2(
								_Utils_update(
									ctx_,
									{classtb: newClassTb, env: newEnv}),
								A3($author$project$OOP$Syntax$TList, ws, t1_, t2_));
						case 'Delete':
							var _v193 = delta.a;
							var resDelta = delta.b;
							var _v194 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
							var v1 = _v194.a;
							var state1 = _v194.b;
							var _v195 = A4(
								$author$project$OOP$UnEval$deltaUpdate,
						...
						case 'Insert':
							...
							var _v198 = A4($author$project$OOP$UnEval$deltaUpdate, term, resDelta, ctx, newState);
							var ctx_ = _v198.a;
							var term_ = _v198.b;
							return _Utils_Tuple2(
								ctx_,
						...
						default:
							var v = delta.a.a;
							var resDelta = delta.b;
							var _v200 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
							var state1 = _v200.b;
							var _v201 = A4(
								$author$project$OOP$UnEval$deltaUpdate,
								t2,
			...
			case 'TEmpList':
				...
				if (delta.b) {
					if (delta.a.$ === 'Insert') {
						...
						var _v204 = A4($author$project$OOP$UnEval$deltaUpdate, term, resDelta, ctx, newState);
						var ctx_ = _v204.a;
						var term_ = _v204.b;
						return _Utils_Tuple2(
							ctx_,
				...
				if (delta.b) {
					switch (delta.a.$) {
						case 'Keep':
							var _v207 = delta.a;
							var resDelta = delta.b;
							var _v208 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
							var v1 = _v208.a;
							var state1 = _v208.b;
							var _v209 = A4(
								$author$project$OOP$UnEval$deltaUpdate,
							...
							return _Utils_Tuple2(
								_Utils_update(
									ctx1_,
									{state: ctx_.state}),
								A3($author$project$OOP$Syntax$TString, ws, t1, t2_));
						case 'Delete':
							var _v211 = delta.a;
							var resDelta = delta.b;
							var _v212 = A4($author$project$OOP$UnEval$deltaUpdate, t2, resDelta, ctx, newState);
							var ctx_ = _v212.a;
							var t2_ = _v212.b;
							switch (t2_.$) {
								case 'TString':
									...
									return _Utils_Tuple2(
										ctx_,
										A3($author$project$OOP$Syntax$TString, ws, t, ts));
								case 'TEmpStr':
									return _Utils_Tuple2(
										ctx_,
										$author$project$OOP$Syntax$TEmpStr(ws));
								default:
									return _Utils_Tuple2(
										ctx,
										$author$project$OOP$Syntax$TError('Error : 32.'));
							}
						case 'Insert':
							var v = delta.a.a;
							var resDelta = delta.b;
							var t_ = A2(
								...
								_List_fromArray(
									['']));
							var _v214 = A4($author$project$OOP$UnEval$deltaUpdate, term, resDelta, ctx, newState);
							var ctx_ = _v214.a;
							var term_ = _v214.b;
							return _Utils_Tuple2(
								ctx_,
								A3($author$project$OOP$Syntax$TString, ws, t_, term_));
						default:
							var v = delta.a.a;
							var resDelta = delta.b;
							var _v215 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
							var state1 = _v215.b;
							var _v216 = A4(
								$author$project$OOP$UnEval$deltaUpdate,
								t2,
							...
							return _Utils_Tuple2(
								ctx_,
								A3($author$project$OOP$Syntax$TString, ws, t1_, t2_));
					}
				} else {
					return _Utils_Tuple2(
						ctx,
						$author$project$OOP$Syntax$TError('Diff Solve Error : 03.'));
				}
			case 'TEmpStr':
				var ws = term.a;
				if (delta.b) {
					if (delta.a.$ === 'Insert') {
						...
						var t_ = A2(
							...
							_List_fromArray(
								['']));
						var _v219 = A4($author$project$OOP$UnEval$deltaUpdate, term, resDelta, ctx, newState);
						var ctx_ = _v219.a;
						var term_ = _v219.b;
						return _Utils_Tuple2(
							ctx_,
						...
						return _Utils_Tuple2(
							ctx,
							$author$project$OOP$Syntax$TError('Diff Solve Error : 04.'));
					}
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$OOP$UnEval$logic = F6(
	function (ctx, t1, t2, updates, ws, op) {
		var _v153 = A4(
			$author$project$OOP$Eval$eval,
			ctx.env,
			...
			A4($author$project$OOP$Syntax$TBPrim, _List_Nil, op, t1, t2));
		var vo = _v153.a;
		var _v154 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
		var v1 = _v154.a;
		var state1 = _v154.b;
		var _v155 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, t2);
		var v2 = _v155.a;
		var _v156 = function () {
			switch (vo.$) {
				case 'VTrue':
					var _v158 = updates.value;
					switch (_v158.$) {
						case 'VTrue':
							return _Utils_Tuple2(v1, v2);
						case 'VFalse':
							var _v159 = _Utils_Tuple3(v1, v2, op);
							_v159$4:
							while (true) {
								switch (_v159.a.$) {
									case 'VTrue':
				...
				case 'VFalse':
					var _v172 = updates.value;
					switch (_v172.$) {
						case 'VFalse':
							return _Utils_Tuple2(v1, v2);
						case 'VTrue':
							var _v173 = _Utils_Tuple3(v1, v2, op);
							_v173$4:
							while (true) {
								switch (_v173.a.$) {
									case 'VTrue':
										if ((_v173.b.$ === 'VFalse') && (_v173.c.$ === 'And')) {
											var _v180 = _v173.a;
											var _v181 = _v173.b;
											var _v182 = _v173.c;
		...
		var newV_1 = _v156.a;
		var newV_2 = _v156.b;
		var _v186 = _Utils_Tuple2(newV_1, newV_2);
		if ((_v186.a.$ === 'VError') && (_v186.b.$ === 'VError')) {
			return _Utils_Tuple2(
				ctx,
				$author$project$OOP$Syntax$TError(
...
var $author$project$OOP$UnEval$operationUpdate = F8(
	function (ctx, op, t1, t2, updates, newV_1, newV_2, ws) {
		var _v150 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
		var state1 = _v150.b;
		var _v151 = A3(
			$author$project$OOP$UnEval$uneval,
			_Utils_update(
		...
		var ctx_ = _v152.a;
		var t1_ = _v152.b;
		var newClassTb = A4($author$project$OOP$LangUtils$mergeClassTable, ctx1_.classtb, ctx_.classtb, ctx.classtb, ctx.classtb);
		var newEnv = A3($author$project$OOP$LangUtils$mergeEnv, ctx_.env, ctx1_.env, ctx.env);
		return _Utils_Tuple2(
			{classtb: newClassTb, env: newEnv, state: ctx_.state},
			A4($author$project$OOP$Syntax$TBPrim, ws, op, t1_, t2_));
	});
var $author$project$OOP$UnEval$uneval = F3(
	function (ctx, term, updates) {
		switch (term.$) {
			case 'TInt':
				var ws = term.a;
			...
			case 'TString':
				var _v40 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, term);
				var origin_val = _v40.a;
				var _v41 = A2($author$project$OOP$LangUtils$diff, origin_val, updates.value);
				var delta = _v41.b;
				return A4($author$project$OOP$UnEval$deltaUpdate, term, delta, ctx, updates.state);
			case 'TEmpStr':
				var ws = term.a;
				var _v42 = updates.value;
				switch (_v42.$) {
					case 'VEmpStr':
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'TVar':
				...
				return _Utils_Tuple2(
					_Utils_update(
						ctx,
						{env: env_, state: updates.state}),
					A2($author$project$OOP$Syntax$TVar, ws, s));
			case 'TLam':
				var ws = term.a;
				var _v43 = updates.value;
				if (_v43.$ === 'VClosure') {
					var p_ = _v43.a;
					var t_ = _v43.b;
					var env_ = _v43.c;
			...
			case 'TApp':
				if (term.c.$ === 'TFix') {
					...
					var _v44 = term.c;
					var t2 = _v44.b;
					var _v45 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var v1 = _v45.a;
					var state1 = _v45.b;
					if (v1.$ === 'VClosure') {
						var p = v1.a;
						...
						if (p.$ === 'PVar') {
							...
							if (tf_.$ === 'TError') {
								...
								var _v50 = A3($author$project$OOP$UnEval$uneval, ctx, t1, newUpdates_1);
								var ctx_ = _v50.a;
								var t1_ = _v50.b;
								var newClassTb = A4($author$project$OOP$LangUtils$mergeClassTable, ctx_.classtb, ctx1.classtb, ctx.classtb, ctx.classtb);
								if (t1_.$ === 'TError') {
									var info = t1_.a;
									return _Utils_Tuple2(
										ctx,
									...
									var _v52 = A2($author$project$OOP$Utils$findByName, s, ctx1.env);
									if (_v52.$ === 'Just') {
										switch (_v52.a.$) {
											case 'VClosure':
												var _v53 = _v52.a;
					...
					var t1 = term.b;
					var t2 = term.c;
					var _v56 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var v1 = _v56.a;
					var state1 = _v56.b;
					if (v1.$ === 'VClosure') {
						var p = v1.a;
						var tf = v1.b;
						var envf = v1.c;
						var _v58 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, t2);
						var v2 = _v58.a;
						var state2 = _v58.b;
						var envm = A2($author$project$OOP$LangUtils$match, p, v2);
						var _v59 = A3(
						...
						if (tf_.$ === 'TError') {
							...
							if (t2_.$ === 'TError') {
								...
								var _v63 = A3($author$project$OOP$UnEval$uneval, ctx, t1, newUpdates_1);
								var ctx_ = _v63.a;
								var t1_ = _v63.b;
								if (t1_.$ === 'TError') {
									var info = t1_.a;
									...
									var newEnv = A3($author$project$OOP$LangUtils$mergeEnv, ctx1_.env, ctx_.env, ctx.env);
									var newClassTb = A4($author$project$OOP$LangUtils$mergeClassTable, ctx_.classtb, ctx1_.classtb, ctx2_.classtb, ctx.classtb);
									return _Utils_Tuple2(
										{classtb: newClassTb, env: newEnv, state: ctx_.state},
										A3($author$project$OOP$Syntax$TApp, ws, t1_, t2_));
								}
			...
			case 'TCons':
				...
				var t1 = term.b;
				var t2 = term.c;
				var _v80 = updates.value;
				switch (_v80.$) {
					case 'VCons':
						var v1 = _v80.a;
						var v2 = _v80.b;
						var _v81 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
						var state1 = _v81.b;
						var _v82 = A3(
							$author$project$OOP$UnEval$uneval,
							_Utils_update(
			...
			case 'TList':
				var _v84 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, term);
				var origin_val = _v84.a;
				var _v85 = A2($author$project$OOP$LangUtils$diff, origin_val, updates.value);
				var delta = _v85.b;
				return A4($author$project$OOP$UnEval$deltaUpdate, term, delta, ctx, updates.state);
			case 'TNil':
				var ws = term.a;
				var _v86 = updates.value;
				switch (_v86.$) {
					case 'VNil':
						return _Utils_Tuple2(
							_Utils_update(
			...
			case 'TEmpList':
				var _v87 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, term);
				var origin_val = _v87.a;
				var _v88 = A2($author$project$OOP$LangUtils$diff, origin_val, updates.value);
				var delta = _v88.b;
				return A4($author$project$OOP$UnEval$deltaUpdate, term, delta, ctx, updates.state);
			case 'TTuple2':
				var ws = term.a;
			...
			case 'TTuple3':
				...
				var t2 = term.c;
				var t3 = term.d;
				var _v93 = updates.value;
				if (_v93.$ === 'VTuple3') {
					var v1 = _v93.a;
					var v2 = _v93.b;
					var v3 = _v93.c;
					var _v94 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var state1 = _v94.b;
					var _v95 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, t2);
					var state2 = _v95.b;
					var _v96 = A3(
						$author$project$OOP$UnEval$uneval,
						_Utils_update(
					...
					var ctx_ = _v98.a;
					var t1_ = _v98.b;
					var newClassTb = A4($author$project$OOP$LangUtils$mergeClassTable, ctx2_.classtb, ctx1_.classtb, ctx_.classtb, ctx.classtb);
					var newEnv = A3(
						$author$project$OOP$LangUtils$mergeEnv,
						ctx2_.env,
						A3($author$project$OOP$LangUtils$mergeEnv, ctx1_.env, ctx_.env, ctx.env),
						ctx.env);
					return _Utils_Tuple2(
						{classtb: newClassTb, env: newEnv, state: ctx_.state},
			...
			case 'TBPrim':
				...
				var t1 = term.c;
				var t2 = term.d;
				var logic_ = A5($author$project$OOP$UnEval$logic, ctx, t1, t2, updates, ws);
				var comp_ = A5($author$project$OOP$UnEval$comp, ctx, t1, t2, updates, ws);
				var arith_ = A5($author$project$OOP$UnEval$arith, ctx, t1, t2, updates, ws);
				switch (op.$) {
					case 'And':
			...
			case 'TUPrim':
				...
				var op = term.b;
				var t = term.c;
				return A5($author$project$OOP$UnEval$unevalUnaryOperation, ctx, op, t, updates, ws);
			case 'TParens':
				var ws = term.a;
				var t = term.b;
				var _v100 = A3($author$project$OOP$UnEval$uneval, ctx, t, updates);
				var ctx_ = _v100.a;
				var t_ = _v100.b;
				return _Utils_Tuple2(
					ctx_,
			...
			case 'TRef':
				var ws = term.a;
				var t = term.b;
				var _v101 = updates.value;
				if (_v101.$ === 'VLoc') {
					var n = _v101.a;
					var _v102 = A2($author$project$Utils$nth, n, updates.state);
					if (_v102.$ === 'Just') {
						var newV = _v102.a;
						var _v103 = $elm_community$list_extra$List$Extra$unconsLast(updates.state);
						if (_v103.$ === 'Just') {
							var _v104 = _v103.a;
							var state1 = _v104.b;
							var _v105 = A3(
			...
			case 'TDeRef':
				var ws = term.a;
				var t = term.b;
				var _v106 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t);
				var v1 = _v106.a;
				if (v1.$ === 'VLoc') {
					var n = v1.a;
					var _v108 = A2($author$project$Utils$nth, n, ctx.state);
					if (_v108.$ === 'Just') {
						var v2 = _v108.a;
			...
			case 'TAssign':
				...
				var t1 = term.b;
				var t2 = term.c;
				var _v111 = updates.value;
				if (_v111.$ === 'VUnit') {
					var _v112 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var v1 = _v112.a;
					var state1 = _v112.b;
					var _v113 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, t2);
					var state2 = _v113.b;
					if (v1.$ === 'VLoc') {
						var n = v1.a;
						...
						if (_v115.$ === 'Just') {
							var newV = _v115.a;
							var _v116 = A2($author$project$Utils$nth, n, state2);
							if (_v116.$ === 'Just') {
								var oriV = _v116.a;
								var _v117 = A3(
									$author$project$OOP$UnEval$uneval,
			...
			case 'TField':
				...
				if (t2.$ === 'TVar') {
					var f = t2.b;
					var _v121 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var v1 = _v121.a;
					if (v1.$ === 'VNew') {
						var _class = v1.a;
						var args = v1.b;
			...
			case 'TInvk':
				...
				if (t2.$ === 'TVar') {
					var m = t2.b;
					var _v126 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var v1 = _v126.a;
					if (v1.$ === 'VNew') {
						var _class = v1.a;
						var res = A3($author$project$OOP$LangUtils$findMethod, m, _class, ctx.classtb);
						if (res.$ === 'Just') {
							var _v129 = updates.value;
							if (_v129.$ === 'VClosure') {
								var t_ = _v129.b;
								var env_ = _v129.c;
								var newClassTb = A4($author$project$OOP$LangUtils$updateClassTable, m, _class, t_, ctx.classtb);
								if (env_.b && (env_.a.a === 'this')) {
									var _v131 = env_.a;
									var newV_1 = _v131.b;
									var _v132 = A3(
										$author$project$OOP$UnEval$uneval,
										ctx,
										t1,
										{state: updates.state, value: newV_1});
									var ctx_ = _v132.a;
									var t1_ = _v132.b;
									return _Utils_Tuple2(
										_Utils_update(
			...
			case 'THtml':
				...
				var t2 = term.d;
				var t3 = term.e;
				var _v138 = updates.value;
				if (_v138.$ === 'VHtml') {
					var v1 = _v138.b;
					var v2 = _v138.c;
					var v3 = _v138.d;
					var _v139 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t1);
					var state1 = _v139.b;
					var _v140 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, t2);
					var state2 = _v140.b;
					var _v141 = A3(
						$author$project$OOP$UnEval$uneval,
						_Utils_update(
			...
			case 'TMap':
				var _v147 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, term);
				var origin_val = _v147.a;
				var _v148 = A2($author$project$OOP$LangUtils$diff, origin_val, updates.value);
				var delta = _v148.b;
				return A4($author$project$OOP$UnEval$updateMap, term, delta, ctx, updates.state);
			default:
				var ws = term.a;
...
var $author$project$OOP$UnEval$unevalUnaryOperation = F5(
	function (ctx, op, t, updates, ws) {
		var _v20 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, t);
		var v = _v20.a;
		if (op.$ === 'Not') {
			switch (v.$) {
				case 'VTrue':
					var _v23 = updates.value;
					switch (_v23.$) {
						case 'VTrue':
							var _v24 = A3(
								$author$project$OOP$UnEval$uneval,
...
var $author$project$OOP$UnEval$updateMap = F4(
	function (term, delta, ctx, newState) {
		if (term.$ === 'TMap') {
			var ws = term.a;
			var d = term.b;
			var f = term.c;
			var ls = term.d;
			var _v17 = A4($author$project$OOP$Eval$eval, ctx.env, ctx.state, ctx.classtb, f);
			var v1 = _v17.a;
			var state1 = _v17.b;
			var _v18 = A4($author$project$OOP$Eval$eval, ctx.env, state1, ctx.classtb, ls);
			var v2 = _v18.a;
			switch (v2.$) {
				case 'VCons':
					var res = A9($author$project$OOP$UnEval$updateMapHelper, v1, v2, delta, ctx, newState, state1, f, ls, d);
					return _Utils_Tuple2(
						res.a,
						A4($author$project$OOP$Syntax$TMap, ws, d, f, res.b));
				case 'VNil':
					var res = A9($author$project$OOP$UnEval$updateMapHelper, v1, v2, delta, ctx, newState, state1, f, ls, d);
					return _Utils_Tuple2(
						res.a,
...
var $author$project$OOP$UnEval$updateMapHelper = F9(
	function (v1, v2, delta, ctx, newState, state1, f, ls, d) {
		var v2_ = A6($author$project$OOP$UnEval$updateMap_, f, v2, delta, ctx, d, newState);
		var _v14 = A3(
			$author$project$OOP$UnEval$uneval,
			_Utils_update(
				ctx,
...
var $author$project$OOP$UnEval$updateMap_ = F6(
	function (f, v, delta, ctx, _default, newState) {
		updateMap_:
		while (true) {
			switch (v.$) {
				case 'VCons':
					...
					if (delta.b) {
						switch (delta.a.$) {
							case 'Keep':
								var _v2 = delta.a;
								var resDelta = delta.b;
								var v2_ = A6($author$project$OOP$UnEval$updateMap_, f, v2, resDelta, ctx, _default, newState);
								return A2($author$project$OOP$Syntax$VCons, v1, v2_);
							case 'Delete':
								var _v3 = delta.a;
								var resDelta = delta.b;
								var $temp$f = f,
							...
							case 'Insert':
								var v_ = delta.a.a;
								var resDelta = delta.b;
								var v2_ = A6($author$project$OOP$UnEval$updateMap_, f, v, resDelta, ctx, _default, newState);
								var _v4 = A3(
									$author$project$OOP$UnEval$uneval,
									ctx,
								...
								if (res.$ === 'TApp') {
									...
									var _v6 = A4(
										...
										default_);
									var v1_ = _v6.a;
									return A2($author$project$OOP$Syntax$VCons, v1_, v2_);
								} else {
									return $author$project$OOP$Syntax$VError('Error : 28.');
								}
							default:
								var v_ = delta.a.a;
								var resDelta = delta.b;
								...
								if (res.$ === 'TApp') {
									...
									return $author$project$OOP$Syntax$VError('Error : 29.');
								}
						}
					} else {
						return $author$project$OOP$Syntax$VError('Diff Solve Error : 05.');
					}
				case 'VNil':
					if (delta.b) {
						if (delta.a.$ === 'Insert') {
							var v_ = delta.a.a;
							var resDelta = delta.b;
							var v2_ = A6($author$project$OOP$UnEval$updateMap_, f, $author$project$OOP$Syntax$VNil, resDelta, ctx, _default, newState);
							var _v11 = A3(
								$author$project$OOP$UnEval$uneval,
								ctx,
								A3($author$project$OOP$Syntax$TApp, _List_Nil, f, _default),
							...
							if (res.$ === 'TApp') {
								...
								return $author$project$OOP$Syntax$VError('Error : 30.');
							}
						} else {
							return $author$project$OOP$Syntax$VError('Diff Solve Error : 06.');
						}
					} else {
						return $author$project$OOP$Syntax$VNil;
					}
				default:
					return $author$project$OOP$Syntax$VError('Error : 27.');
			}
		}
	});
